 ...
 * overflow-hidden here keeps the off-screen blobs from widening the page.
 */
export default function BackgroundBlobs() {
  return (
    <div aria-hidden="true" className="fixed inset-0 overflow-hidden pointer-events-none">
      <div className="absolute top-[-10%] left-[-5%] w-[400px] h-[400px] bg-emerald-300 rounded-full opacity-80 dark:opacity-[0.15] animate-blob transition-opacity duration-500" />
      <div
      ...
      />
      <div
        className="absolute bottom-[-20%] left-[-10%] w-[700px] h-[700px] bg-teal-600 rounded-full opacity-80 dark:opacity-[0.15] animate-blob transition-opacity duration-500"
      ...
      <div className="absolute bottom-[30%] right-[25%] w-8 h-8 bg-emerald-300 rounded-full opacity-90 dark:opacity-40 transition-opacity duration-500" />
      ...
      <div className="absolute bottom-[20%] left-[30%] w-10 h-10 bg-teal-400 rounded-full opacity-90 dark:opacity-40 transition-opacity duration-500" />
    </div>
  );
}
